...
# ----putting the sounds ----
eat_apple = pygame.mixer.Sound('munch-sound-effect.mp3')
get_star = pygame.mixer.Sound('speedboost.mp3')
get_teleport = pygame.mixer.Sound('teleport.mp3')
bg_music = pygame.mixer.Sound('16-bit Jungle Music  Chiptune for Games  Mazy Jungle.mp3')
gm_over = pygame.mixer.Sound('gameover.mp3')
